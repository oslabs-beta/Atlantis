...
import space_update_drop from '../assets/space_update_drop.svg';
    ...
    <>
      <div className="about-container">
        <div className="about-left">
          <h2>
            Atlantis is a light-weight library that solves the issue of storing
            and maintaining deeply-nested GraphQL queries
          </h2>
          <p>
            Ensuring the client always receives the most relevant data as
            mutations are made to the database.{' '}
          </p>
        </div>
      ...
      <div className="about-container">
        <div className="redis-left">
          <h1>Saving Time</h1>
          <img
            src="https://media.giphy.com/media/rok0zBiCcCMrMFvS9x/giphy.gif"
            width="300"
          />
        </div>
        <div className="redis-right">
          <h2>
            Atlantis leverages Redis's 'in-memory' quick lookup time to rapidly
            serve up cached graphQL responses regardless of size or structure.
          </h2>
          <img src={server_light} className="server" />
          <p>
            Redis integration along with Pub/Sub architecture also allows for
            scaling as your needs grow and you require more cache space or
            backup cache workers
          </p>
        </div>
      </div>
      <div className="about-container">
        <div className="server-left">
          <h2>
            New queries that bear resemblance to previous queries are
            intelligently pulled from the existing cached nesting instead of
            creating a new key/value entry{' '}
          </h2>
        </div>
        <div className="server-right">
          <h1>Saving Space</h1>
          <img src={space_update_drop} />
        </div>
      </div>
